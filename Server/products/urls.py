...
from .views import AddProductView,CommentView,ProductListView, ProductDeleteView, ProductUpdateView,FarmerProductListView,AddToCartView,CartListView,CreateOrderView,CartDeleteView,OrderDeleteView,RecentOrdersView
